...
class Codebook(object):
    ...
    def __init__(self, mapsize, lattice="rect"):
        ...
        if lattice == "hexa":
            ...
            self.lattice_distances = sp.spatial.distance_matrix(coordinates, coordinates).reshape(n_rows * n_columns, n_rows, n_columns)
    ...
    def _rect_dist(self, node_ind):
        ...
        if rows > 0 and cols > 0:
            ...
            raise InvalidMapsizeError(f"One or both of the map dimensions are invalid. Cols '{cols}', Rows '{rows}'")
